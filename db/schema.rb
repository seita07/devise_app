...
ActiveRecord::Schema.define(version: 20_210_526_045_701) do
  ...
  create_table 'methodposts', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: 6, null: false
    t.string 'subjects'
    t.index %w[user_id created_at], name: 'index_methodposts_on_user_id_and_created_at'
  ...
  create_table 'timeposts', force: :cascade do |t|
    ...
    t.integer 'studytime'
    t.datetime 'datetime'
    t.index %w[user_id created_at], name: 'index_timeposts_on_user_id_and_created_at'
  end
